<div class="signUp">
    ...
    <form action="" id="formSignUp">
        <div>
            <input type="text" placeholder="Tên đăng nhập" id="user" class="mb20">
            <p class="err errUser">Ít nhất 6 kí tự gồm chữ cái và số</p>
        </div>
        <div>
            <input type="text" placeholder="Email" id="email" class="mb20">
            <p class="err errEmail">Email phải có đuôi '@gmail.com'</p>
        </div>
        <div>
            <input type="password" id="pass" placeholder="Mật khẩu"><div class="icon icon1"><i class="fa-solid fa-eye"></i></div>
            <p class="err errPass">Ít nhất 8 kí tự gồm chữ cái, kí tự đặc biệt và số</p>
        </div>
        <div>
            <input type="password" id="repass" placeholder="Nhập lại mật khẩu"><div class="icon icon2"><i class="fa-solid fa-eye"></i></div>
