        ...
        <table class="table-hung table_account">
            ...
            <tbody id="body-listUser">
                ...
                <tr class="trListAccount">
                    ...
                    <td><a style="text-decoration: none;color: black;" href="<?= $adminUrl . "account/accountInfo&id=".$acc['id'] ?>"><?php echo $acc['u_username'] ?></a></td>
                    ...
                    <td>
                        <a class="btn btn-info" href="<?= $adminUrl . "account/update&id=" . $acc['id'] ?>">Sửa</a> 
                        <a class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')"
                            href="<?= $adminUrl . "account/delete&id=" . $acc['id'] ?>">Xóa</a>
                    </td>
